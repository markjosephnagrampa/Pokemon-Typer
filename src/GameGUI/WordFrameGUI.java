 ...
 */
public class WordFrameGUI extends JFrame implements ActionListener {
	...
	//Constructor
		public WordFrameGUI(int mode){ //0-easy 1-medium 2-hard 3-extreme
		...
		//JPanel Elements
			//the component with the threading words
	...
	//Internal methods
		...
		//Timer Checkers
			...
			public void actionPerformed(ActionEvent e) {
				//Stop Game if Either Player have empty life bars
				...
				}//end of else [No empty Life bars]
			}//end of actionPerformed [timer activated]
	
		//JFrame Closing Method
			public void close(){
				this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
				WindowEvent winClosingEvent = new WindowEvent(this,WindowEvent.WINDOW_CLOSING);
				Toolkit.getDefaultToolkit().getSystemEventQueue().postEvent(winClosingEvent);
			}
		//Replacement for Char.isAlphabetic(char c) fcn	
	...
	//KeyListener for JTextField typing
